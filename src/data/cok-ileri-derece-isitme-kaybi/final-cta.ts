// Final CTA content for the /ihtiyaciniza-gore/
// cok-ileri-derece-isitme-kaybi page — the page's last section. Renders
// through the shared BrandPageFinalCta component. Same real contact
// channels (contactConfig) and verified trust facts used across the
// site.

import { contactConfig } from "../../config";
import type { BrandPageFinalCtaContent } from "../../components/brand-page/BrandPageFinalCta/BrandPageFinalCta.astro";

export const cokIleriDereceIsitmeKaybiFinalCta: BrandPageFinalCtaContent = {
  badge: "UZMAN DESTEĞİ",
  ...
  accentColorShadow: "rgb(146 64 14 / 0.55)",
  accentColorShadowHover: "rgb(146 64 14 / 0.65)",
  accentColorFocus: "rgb(146 64 14 / 0.5)",
  accentColorTrustBg: "rgb(146 64 14 / 0.16)",
};
